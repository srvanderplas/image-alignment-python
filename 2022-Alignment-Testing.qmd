...
v, u = optical_flow_ilk(xcrop[0], xcrop[3], radius=250, gaussian = True, prefilter = True)
...
xcrop1_warp = warp(xcrop[3], np.array([row_coords + v, col_coords + u]),
                   mode='edge')
